...
const uuidParamPipe = new common_1.ParseUUIDPipe({
    exceptionFactory: () => new common_1.BadRequestException({
        error: {
...
__decorate([
    (0, common_1.Get)(':id'),
    __param(0, (0, common_1.Param)('id', uuidParamPipe)),
    __metadata("design:type", Function),
...
__decorate([
    ...
    __metadata("design:paramtypes", [String, update_post_dto_1.UpdatePostDto]),
    __metadata("design:returntype", void 0)
], PostsController.prototype, "partialUpdate", null);
__decorate([
